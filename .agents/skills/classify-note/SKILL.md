...
## Related
- [ingest-source](../ingest-source/SKILL.md) — calls this (or equivalent logic) as step 3.
- [extract-metadata](../extract-metadata/SKILL.md) — sibling for other frontmatter fields.
- `.context/routing-policy.md` and `10_knowledge/index.md` — the source of truth for rules and domain inventory.

## Related

- [ingest-source](../ingest-source/SKILL.md) — the parent skill
- [extract-metadata](../extract-metadata/SKILL.md) — fills in the rest of frontmatter
