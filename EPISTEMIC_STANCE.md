...
1. **Separate Facts from Inferences**
   - *Observation/Fact*: "The script returned error 500 on 3 successive attempts."
   - *Inference/Hypothesis*: "The API rate limit is likely being exceeded."
   - Do not state inferences as facts. Label them explicitly.

2. **Source-Backed Confirmation**
   - For high-risk or live-updating domains (especially finance, legal, and markets), all claims must link to their supporting raw source (the "evidence").
